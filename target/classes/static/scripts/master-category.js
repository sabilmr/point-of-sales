            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        // Creates full output for name and Category Detail
                        var $row_output =
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        var $totalProduct = full['totalProduct'];
                        return '<div class="text-sm-end">' + $totalProduct + '</div>';
                    }
                },
                {
                    // Total Earnings
                    ...
                    orderable: false,
                    render: function (data, type, full, meta) {
                        var $totalEarning = full['totalEarning'];
                        return "<div class='h6 mb-0 text-sm-end'>" + $totalEarning + '</div';
                    }
                },
                {
                    // Actions
